...
global PIloc
mainsaveloc = [PIloc, 'CoverageRates/1Dtstat/ServerRuns/'];
mkdir(mainsaveloc)
...
edge_effect = ceil( 6 * FWHM2sigma( 9 ) );
peak_centres = (5:10:(10*(npeaks-1)+5))+ edge_effect;
for peak = 1:npeaks
...
xvals = 1:increm:(10*npeaks + 2*edge_effect); 
...
for I = 1:length(rc.FWHM_vec)
    ...
    for J = 1:length(rc.nsubj_vec)
        ...
        [rc.ellvals{I,J}, rc.maxhist{I,J}, rc.coverage{I,J}, rc.bonf_coverage{I,J}] = convCIcoverage(data_info, rc.niters, 't', sim_type);
