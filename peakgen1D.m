...
%  peakparams a cell array each entry being a 2D vector giving the
%             parameters of the beta distribution used to generate the peak
%  peakheights
% Optional
...
%               of the signal
%   meanfn      a function handle given the values of the mean
%--------------------------------------------------------------------------
% EXAMPLES
